...
public class Nain:Race {
    ...
    public Nain() : base("Nain", "Combattant robuste et obstiné, expert des profondeurs et de la forge.", 
        "Forgeron", "Considère que porter une armure \"Commune\" est une insulte à ses ancêtres.") {
        statsRace.force = 1;
